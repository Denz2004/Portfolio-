...
W8DINCW.all.lm.no_outliers <- lm(log_of_W8DINCW ~ . - log_of_W8DINCW- W1empsdad   - W1ch3_11HH - W6OwnchiDV - W5JobYP - W8TENURE - log_of_W8QDEB2
                                 ...
                                 - W1hous12HH - W8DACTIVITY,data = clean_data_no_outliers)
