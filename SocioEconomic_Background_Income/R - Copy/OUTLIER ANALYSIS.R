...
absolute_differences <- abs(exp(predicted_values)[two_out_of_three] - actual_values[two_out_of_three])

cat("Predicted: ", exp(predicted_values[two_out_of_three]))
...
W8DINCW.all.lm.no_outliers <- lm(log(W8DINCW) ~ . - W6OwnchiDV - W2ghq12scr_binary - W4empsYP - W4RacismYP - W1InCarHH
